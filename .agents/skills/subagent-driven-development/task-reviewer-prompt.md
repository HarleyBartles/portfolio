...
- `[BRIEF_FILE]` — REQUIRED: the task brief file (`py -3 subagent-workspace/scripts/task_brief.py --apply PLAN N`
...
- `[DIFF_FILE]` — REQUIRED: the path the controller wrote the review
  package to (`py -3 subagent-workspace/scripts/review_package.py --apply PLAN_FILE BASE HEAD` prints the unique
