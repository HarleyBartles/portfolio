...
for script in scaffold-repo-runbook-policy scaffold-runbooks scaffold-playbooks scaffold-review scaffold-contributing scaffold-gitignore scaffold-agents-md scaffold-marketplace-json; do
    echo "==> running ${script}"
