...
![A diagram of a house.](images/small/shearing-layers.jpg)
...
1. [Inclusive Web Design For the Future with Progressive Enhancement](http://www.hesketh.com/publications/inclusive_web_design_for_the_future/) by Steven Champeon and Nick Finck
2. [Do websites need to look exactly the same in every browser?](https://web.archive.org/web/20071212220950/http://dowebsitesneedtolookexactlythesameineverybrowser.com/) by Dan Cederholm
3. [Support vs Optimization](http://bradfrost.com/blog/mobile/support-vs-optimization/) by Brad Frost
4. [The Pastry Box](https://the-pastry-box-project.net/scott-jehl/2014-march-7) by Scott Jehl
