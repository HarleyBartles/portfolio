...
When the Web Standards Project ran its campaign encouraging designers to switch from `TABLE`s for layout to CSS, it was met with resistance. Time and time again they were criticised for their naïvety. “Sure, a CSS‐based layout might be fine for a simple personal site but there’s no way it could scale to a large complex project.”
...
There may well be situations where the three‐step approach won’t work, but they’re not as common as you might think. If you’re building a 3D game in a web browser, the simplest technology capable of providing the core functionality will still be pretty complex. That said, I’d love to see a text‐only adventure game get enhanced into a first‐person shooter.
...
![Grace Hopper in uniform in front of an American flag.](images/small/grace-hopper.jpg)

Commodore Grace M. Hopper, United States Navy.
...
![A jumbled pile of phones, tablets, e‐readers.](images/small/devices.jpg)

A small sample of internet‐enabled devices.
...
![A child’s space helmet.](images/small/future-friendly.png)

The Future Friendly symbol.

## Assumptions

“We demand rigidly‐defined areas of doubt and uncertainty!” cried the philosophers in Douglas Adams’ Hitchhiker’s Guide To The Galaxy.
...
These kind of assumptions always remind me of old physicist jokes. “Assume a perfectly spherical web browser…”
...
As tempting as this siren call is, it obfuscates the true nature of the ever‐changing uncertain web. Carl Sagan put it best in his book The Demon‐Haunted World:
...
1. [Government Service Design Manual](https://www.gov.uk/service-manual)
2. [Future Friendly](http://futurefriendlyweb.com/)
