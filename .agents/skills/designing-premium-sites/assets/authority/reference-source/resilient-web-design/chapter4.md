...
![Jon Postel standing by a hand‐drawn diagram of the early internet.](images/small/jon-postel.jpg)

Jon Postel.
Photograph by Irene Fertik, USC News Service.
Copyright 1994, USC.
...
Both of those use cases still exist, but now there’s no need to reach for JavaScript. You can create rollover effects using the `:hover` pseudo‐class in CSS. You can validate form fields using the `REQUIRED` and `TYPE` attributes in HTML.
...
In that case, building web apps depends on a fundamental assumption: JavaScript must be available and reliable. But because of its imperative nature, JavaScript tends to be more fragile than a declarative language like HTML. Relying on JavaScript might not be such a safe assumption after all.
...
![A web browser showing a black screen.](images/small/nasa.png)

The 2015 version of the nasa.gov website with incomplete JavaScript.
...
1. [RFC 761: Transmission Control Protocol](https://tools.ietf.org/html/rfc761#section-2.10) by Jon Postel
2. [Program Links in WWW](https://lists.w3.org/Archives/Public/www-talk/1992MayJun/0006.html) by Tim Berners‐Lee
3. [The Internet’s Original Sin](http://www.theatlantic.com/technology/archive/2014/08/advertising-is-the-internets-original-sin/376041/) by Ethan Zuckerman
4. [Ajax: A New Approach to Web Applications](https://web.archive.org/web/20150910072359/http://adaptivepath.org/ideas/ajax-new-approach-web-applications/) by Jesse James Garrett
5. [Everyone has JavaScript, right?](https://kryogenix.org/code/browser/everyonehasjs.html) by Stuart Langridge
