...
Preserve the accepted current Index composition unless a concrete implementation
defect independently requires repair.
...
The current story copy that says Index works until "one route holds together" is
wrong and must leave the active V2 story.
...
- the outgoing folder state must remain materially recognisable; and
...
- Do not add a route-wide red rope because earlier V2 milestones temporarily used
  one.
...
- [ ] The accepted document-world composition remains recognisably the current
      Index chapter.
- [ ] The yellow note and folded blue material conclude the chapter without
      overpowering Index's evidence field.
...
No unresolved local creative question is known. The Index milestone may move to a
JIT implementation plan after Harley reviews this refactored specification set.
That plan should cover only the semantic correction, minimum page/folder foundation
needed by the first milestone and protection of the accepted composition.
