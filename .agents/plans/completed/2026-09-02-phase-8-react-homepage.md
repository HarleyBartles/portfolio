...
- [x] **Step 3: Implement the smallest typed edition registry**
...
- [x] **Step 1: Write failing semantic/component tests**
...
- [x] **Step 3: Implement focused section components and replace `HomePage`**
...
- Create: `src/client/public/media/homepage/specialists-torn-edge-left.webp`
- Create: `src/client/public/media/homepage/specialists-torn-edge-right.webp`
...
- Create: `src/client/public/media/homepage/specialists-folder.webp`
- Create: `src/client/public/media/homepage/specialists-silk.webp`
- Create: `src/client/public/media/homepage/specialists-rollback.webp`
- Create: `src/client/public/media/homepage/specialists-receipt.webp`
- Create: `src/client/public/media/homepage/specialists-klause-k.webp`
...
- [x] **Step 1: Promote only the accepted source assets**

  Copy existing SVG/WebP sources byte-for-byte. Convert the accepted PNG masters to full-dimension WebP derivatives to satisfy the repository's 400 KB production-image gate; do not regenerate the art, reduce its pixel dimensions, or copy font binaries.

- [x] **Step 2: Verify identity and production references**

  Compare SHA-256 hashes for byte-for-byte copies, verify source/output dimensions for converted rasters, require every output below 400 KB, and search production source to prove no component references `docs/editorial-drafts`.

- [x] **Step 3: Add the Phase 8 homepage custody record**
...
- [x] **Step 1: Add browser assertions that fail against the unstyled translation**
...
- [x] **Step 2: Run homepage e2e and verify RED**
...
- [x] **Step 3: Implement homepage-local SCSS**
...
- [x] **Step 1: Rewrite obsolete browser expectations**
...
- [x] **Step 2: Update representative Windows visual baselines**
...
- [x] **Step 3: Record the durable homepage edition decision**
...
- [x] **Step 4: Run focused unit, homepage e2e, and visual checks**

  Run the home unit tests, `homepage.spec.ts`, and the changed visual test twice on Windows.

- [x] **Step 5: Mark Task 5 checklist items complete in this plan**
...
- [x] **Step 1: Inspect the real React page at all accepted widths**
...
- [x] **Step 2: Repair only genuine production translation defects**
...
- [x] **Step 3: Write the implementation handoff**
...
- [x] **Step 5: Commit normally and let the tracked hook run the complete gate**
...
- [x] **Step 6: Push and verify PR #48**

  Push the existing branch, verify the GitHub-visible head and checks, and mark PR #48 ready only after Harley's explicit editorial approval.

- [x] **Step 7: Mark Task 6 checklist items complete in the archived plan**
