...
**Status:** Approved; design wave complete; implementation wave in progress (Phase 5 executing)
...
| 5 | Adventures of Patch showcase and pipeline story | executing | [approved base spec](../../specs/2026-08-21-portfolio-10k-05-patch-pipeline-case-study-design.md) · [Lawful Heist Crew slice](../../specs/2026-08-24-portfolio-10k-05-lawful-heist-crew-design.md) | [foundation plan](2026-08-24-portfolio-10k-phase-5-patch-pipeline.md) · [Lawful Heist Crew JIT plan](2026-08-24-portfolio-10k-phase-5-lawful-heist-crew.md) | local review green; hosted exact-head proof and Harley acceptance pending | [#25](https://github.com/HarleyBartles/portfolio/pull/25) · [#26](https://github.com/HarleyBartles/portfolio/pull/26) | 9/10 | PR #25 established the separate Patch showcase, moved Identity Emporium into it, closed the engineering case study and published Tournament. Draft PR #26 carries the Lawful Heist Crew as a sequential recruitment dossier with six canonical portraits, six purpose-built assent markers and the completed folder as its payoff. The layered composition has been reviewed at 1440, 768, 390 and 320 pixels; the focused desktop/mobile axe route is green and Rollback's signature Windows visual baseline is stable across two unchanged runs. Phase 5 remains open for exact-head hosted proof, Harley's visual acceptance, merge and post-deploy verification. |
