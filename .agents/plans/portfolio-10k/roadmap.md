...
| 5 | Adventures of Patch showcase and pipeline story | executing | [approved spec](../../specs/2026-08-21-portfolio-10k-05-patch-pipeline-case-study-design.md) | [JIT implementation plan](2026-08-24-portfolio-10k-phase-5-patch-pipeline.md) | — | [#25](https://github.com/HarleyBartles/portfolio/pull/25) | 9/10 | The first specialist implementation passed canonical 51 Python / 98 Vitest / 67 Playwright proof, then Harley's rendered-page review exposed a stronger information architecture. Phase 5 now separates a public Adventures of Patch showcase from the engineering case study. Identity Emporium moves intact into the new area, the case study thins to origin and production judgement, and Tournament's agreed four-event progression is persisted for its dedicated page. Draft PR #25 remains open and draft while the approved pivot executes. |
