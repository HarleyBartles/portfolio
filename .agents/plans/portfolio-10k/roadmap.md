...
| 2 | CV and contact conversion | ready | [approved spec](../../specs/2026-08-21-portfolio-10k-02-cv-contact-design.md) | [JIT implementation plan](2026-08-22-portfolio-10k-phase-2-cv-contact.md) | [`6543075`](https://github.com/HarleyBartles/portfolio/commit/6543075ad01d3ac42ad9d6a7f02f4421bdd126c1) | — | 9/10 | Phase 2 starts from merged Phase 1 with marketplace hygiene refreshed. The plan builds the CV, generated PDF, configured Formspree path, and honest disconnected state; live Formspree activation remains external because repository secret metadata has no endpoint entry. |
