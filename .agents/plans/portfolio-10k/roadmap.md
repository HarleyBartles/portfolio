...
| 4 | Wild Bunch architectural proof | executing | [approved spec with 23 August editorial amendment](../../specs/2026-08-21-portfolio-10k-04-wild-bunch-case-study-design.md) | [editorial revision plan](2026-08-23-portfolio-10k-phase-4-editorial-revision.md) | [`c29e449`](https://github.com/HarleyBartles/portfolio/commit/c29e4493a27322cc7d8721d1a208971e19c34eec) (first iteration) | [#22](https://github.com/HarleyBartles/portfolio/pull/22) (merged first iteration) | 9/10 | PR #22 delivered the specialist system, captures, evidence, tests, and first composition, but Harley rejected its defensive and pattern-catalogue editorial result as the Phase 4 exit on 23 August. The corrective branch now tells the story through human architectural reasoning, passes Sol's £10k copy/visual gates and the canonical local suite, and is ready for draft publication. The phase remains open for hosted exact-SHA proof and Harley acceptance; evidence revision and capture custody remain unchanged. |
