...
| 5 | Adventures of Patch showcase and pipeline story | executing | [approved base spec](../../specs/2026-08-21-portfolio-10k-05-patch-pipeline-case-study-design.md) · [Lawful Heist Crew slice](../../specs/2026-08-24-portfolio-10k-05-lawful-heist-crew-design.md) | [foundation plan](2026-08-24-portfolio-10k-phase-5-patch-pipeline.md) | — | [#25](https://github.com/HarleyBartles/portfolio/pull/25) | 9/10 | PR #25 established the separate Patch showcase, moved Identity Emporium into it, closed the engineering case study and published Tournament. Phase 5 remains open for the approved Lawful Heist Crew page, built as a sequential recruitment dossier with six canonical portraits, six purpose-built assent markers and the completed folder as its payoff. |
