...
| 5 | Adventures of Patch pipeline story | executing | [approved spec](../../specs/2026-08-21-portfolio-10k-05-patch-pipeline-case-study-design.md) | [JIT implementation plan](2026-08-24-portfolio-10k-phase-5-patch-pipeline.md) | — | [#25](https://github.com/HarleyBartles/portfolio/pull/25) | 9/10 | Implementation is complete locally against Adventures public main `0240a8657aae5b580c1a7a0d31e0be7a68b27f4e`. The specialist route tells Patch's database-incident origin, production gates, published catalogue, three honest in-flight worlds and controlled creative boundary through exact source custody and reviewed responsive derivatives. Harley's review added story-first hierarchy, truthful Identity Emporium evidence, portrait mobile assets, clearer future-plan lists and a shared case-study lead system. Independent review repairs, the final Sol article/visual gate, the accessible site-wide external-link contract and canonical 51 Python / 98 Vitest / 66 Playwright proof pass. Draft PR #25 is open; hosted exact-SHA checks and Harley's merge decision remain. |
