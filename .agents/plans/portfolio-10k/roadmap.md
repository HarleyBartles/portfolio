...
**Status:** Approved; design wave complete; implementation wave in progress (Phase 4 editorial revision executing)
...
| 4 | Wild Bunch architectural proof | executing | [approved spec with 23 August editorial amendment](../../specs/2026-08-21-portfolio-10k-04-wild-bunch-case-study-design.md) | [editorial revision plan](2026-08-23-portfolio-10k-phase-4-editorial-revision.md) | [`c29e449`](https://github.com/HarleyBartles/portfolio/commit/c29e4493a27322cc7d8721d1a208971e19c34eec) (first iteration) | [#22](https://github.com/HarleyBartles/portfolio/pull/22) (merged first iteration) · [#23](https://github.com/HarleyBartles/portfolio/pull/23) (draft correction) | 9/10 | PR #22 delivered the specialist system, captures, evidence, tests, and first composition, but Harley rejected its defensive and pattern-catalogue editorial result as the Phase 4 exit on 23 August. Draft PR #23 now tells the story through human architectural reasoning and passes Sol's £10k copy/visual gates, three independent reviews and the canonical local suite. The phase remains open for Harley acceptance plus hosted exact-SHA and merge/deploy proof; evidence revision and capture custody remain unchanged. |
| 5 | Adventures of Patch pipeline story | executing | [approved spec](../../specs/2026-08-21-portfolio-10k-05-patch-pipeline-case-study-design.md) | [JIT implementation plan](2026-08-24-portfolio-10k-phase-5-patch-pipeline.md) | — | — | 9/10 | JIT planning began on 24 August 2026 from Adventures public main `0240a8657aae5b580c1a7a0d31e0be7a68b27f4e`, the live specialist case-study seam, and refreshed private planning evidence. The plan preserves the £10k authored voice, public-proof/private-workshop boundary, exact asset custody, and Sol-owned creative gates earned through Phase 4. |
