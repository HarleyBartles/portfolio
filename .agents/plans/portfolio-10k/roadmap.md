...
| 8 | Homepage evidence choreography | pending | [approved spec](../../specs/2026-08-21-portfolio-10k-08-homepage-choreography-design.md) | — | — | — | 9/10 | The dependency gate is clear. A [Cloud editorial decision room](../../../docs/editorial-drafts/phase-8/phase-8-cloud-editorial-brief.md) now owns the remaining hierarchy, copy, art-direction and interaction calls with Harley before local Sol writes the JIT implementation plan. The room must return its decisions to the same draft PR; no homepage implementation begins there. |
