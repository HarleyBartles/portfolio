...
`provisioning-cloud-discovery-record.md` is the durable snapshot of the long-form Cloud discovery conversation. It preserves the cross-repo argument, evidence boundaries, corrections, anti-inferences, voice anchors, related article seeds and unresolved drafting decisions. It is deliberately more complete than the eventual article and must not be mistaken for settled public copy.
