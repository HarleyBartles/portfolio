...
- Article job: show explicit state, guarded transitions, bounded repair and honest termination, then distinguish a disciplined workflow from a trustworthy completion claim.
- Required progression: what a trustworthy review graph needs; why Harley built version one; what version one genuinely improved; how its green remained untrustworthy; what the accepted replacement design and roadmap propose; what has and has not landed.
...
No Cloud discovery answers yet.

Use stable IDs as answers arrive:
...
- Evidence class: first-party account / public repository fact / external source / inference
- Public boundary:
...
- Do not invent a triggering production incident. Ask Harley whether the trustworthiness correction came from one failure, repeated friction, design review or some combination.
- Do not use plan detail as public implementation evidence.

## Unresolved questions

1. What happened that made Harley question the meaning of green?
2. What did version one solve well enough that it deserves to survive the critique?
3. Which false-green weakness felt most important to Harley: coverage, independence, evidence provenance, snapshot drift, or something else?
...
7. Which voice anchors, jokes, irritations or metaphors are unmistakably Harley and worth preserving?
