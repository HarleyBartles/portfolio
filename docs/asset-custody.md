...
The PORT-17 Index draft retains the fourteen accepted PORT-16 raster masters under non-public repository custody at `src/client/assets/patch/the-usual-specialists/index/`. They were copied byte-for-byte from the accepted wireframe source set and total 27,747,221 bytes. `accepted-assets.json` records each stable id, original wireframe filename, repository source path, SHA-256, intrinsic dimensions, accepted status, Harley Bartles as rights owner, and the PORT-16/Linear provenance document id where one is known. Unknown prompt or seed history is deliberately omitted rather than reconstructed.

- Source/derivative boundary: accepted PNG masters are durable reproduction inputs, not public site media. `src/client/scripts/process-usual-specialists-assets.mjs` verifies each committed master against the `accepted-assets.json` manifest in its owning Index or Silk source package before producing one public WebP derivative under `src/client/public/media/patch/the-usual-specialists/`. The generated `usual-specialists-derivatives.json` receipt records source hash, public path, output dimensions, encoding, byte count and output SHA-256.
- Deterministic transform: Sharp 0.34.5 resizes without enlargement to the PORT-17 accepted widths, preserves aspect ratio and alpha, strips metadata, and encodes WebP with `{ quality: 82, alphaQuality: 100, effort: 6, smartSubsample: true }`. `npm run media:usual-specialists:apply` is the only writer; `npm run media:usual-specialists:check` writes nothing and fails on source, derivative or receipt drift.
- Public derivatives: `src/client/public/media/patch/the-usual-specialists/safehouse-threshold.webp`, `src/client/public/media/patch/the-usual-specialists/index-desktop-base.webp`, `src/client/public/media/patch/the-usual-specialists/index-assent-note.webp`, `src/client/public/media/patch/the-usual-specialists/index-blue-carrier.webp`, `src/client/public/media/patch/the-usual-specialists/index-graph-paper.webp`, `src/client/public/media/patch/the-usual-specialists/index-observation.webp`, `src/client/public/media/patch/the-usual-specialists/index-macguffin.webp`, `src/client/public/media/patch/the-usual-specialists/index-walk.webp`, `src/client/public/media/patch/the-usual-specialists/index-inspect.webp`, `src/client/public/media/patch/the-usual-specialists/index-high-step.webp`, `src/client/public/media/patch/the-usual-specialists/index-return.webp`, `src/client/public/media/patch/the-usual-specialists/patch-follow.webp`, `src/client/public/media/patch/the-usual-specialists/patch-leaning.webp`, `src/client/public/media/patch/the-usual-specialists/patch-return.webp`, `src/client/public/media/patch/the-usual-specialists/silk-commission-05-aperture-rim-heavy.webp`, and `src/client/public/media/patch/the-usual-specialists/silk-commission-05-corridor.webp`.
- Generated-image provenance boundary: the fourteen Index masters are the already accepted PORT-16 visual outputs promoted into durable custody; the Commission 05 corridor and heavy mineral-wall frame are the first accepted PORT-18 Silk masters. The portfolio processor does not generate replacement art, infer lost prompts, or lend scratch-only/rejected candidates accepted status. Known Index traversal provenance is Linear document `a6163be5-3bdd-425a-b144-b00e3a88423d`; the accepted Patch return continuation is recorded in `72833c08-cbbe-4674-889a-9024c307c415`.
...
- Silk diegetic-wall custody boundary: the 12 September PORT-18 direction superseded the first rectangular Silk wireframe. `src/client/assets/patch/the-usual-specialists/silk/` is the chapter-specific source package; accepted masters live at its root under its own manifest while selected page-evaluation candidates remain under `silk/candidates/`. Rejected and superseded generations remain outside accepted custody.
- Commission 05 accepted corridor scene: `src/client/assets/patch/the-usual-specialists/silk/silk-commission-05-corridor.png` is the accepted `1086 x 1448` RGB world plate for the first Silk aperture, SHA-256 `cd49b14b67e465df2e69391a670caee88b8f0dd9596ae29c16f0a84e85a8dd99`. Generated with OpenAI image generation under Harley's direction and accepted after final Patch-canon/scene QA on 13 September 2026. Exact prompt and seed are not reconstructed. Accepted-generation provenance is recorded on PORT-16 in Linear document `b4956d48-8d2a-4dbc-9811-0adf212eac2f`. Its deterministic WebP derivative is `src/client/public/media/patch/the-usual-specialists/silk-commission-05-corridor.webp`, `223800` bytes, SHA-256 `35747a59e79ef7a686da977714f849bfb94db32d60139ce70c7d6bb1f15f2076`, encoded with the shared Sharp options. React renders the scene with `80px` hidden vertical overscan per edge and `128px` total parallax travel (`±64px`); after the `8px` per-edge safety reserve, `144px` of safe total travel remains available, so the authored motion stays within concealed source bleed.
- Commission 05 regular aperture-rim evaluation: `src/client/assets/patch/the-usual-specialists/silk/candidates/silk-commission-05-aperture-rim-regular.png` is the `1672 x 941` regular-treatment option first selected for in-situ React assessment, SHA-256 `4729adeae06fe9ae15adc5a9a19489589c002356e42ef8277a2637eedc9e484f`. The locked-composition experiment showed that its thin top edge cannot completely hide a straight rectangular world-viewport boundary: the strongest useful top row still contains transparent breaks. Current status is **rejected for the Commission 05 locked rectangular-viewport role**. It remains in candidate custody as comparison evidence; its temporary public derivative has been removed.
- Commission 05 accepted heavy aperture rim: `src/client/assets/patch/the-usual-specialists/silk/silk-commission-05-aperture-rim-heavy.png` is the accepted `1672 x 941` transparent RGBA mineral-wall frame, SHA-256 `f8f11ab42c3a2d145b4128ea1f3e83058dc75babbacd6dfa7277cc03af5eaff8`, generated with OpenAI image generation under Harley's direction. Harley accepted the heavy treatment after the regular candidate failed the straight rectangular crop-occlusion contract and after live review with the accepted corridor scene. Accepted-generation provenance is recorded on PORT-16 in Linear document `710a99b4-7218-4eab-930a-fea7d4a9ae78`; the durable session history does not retain a trustworthy generation ID, so none is invented. The React composition uses the measured world viewport `x=200..1500`, `y=130..820`; an 8px inward band around every viewport edge remains `alpha >=250`. Sharp 0.34.5 deterministically emits `src/client/public/media/patch/the-usual-specialists/silk-commission-05-aperture-rim-heavy.webp` with the shared encoding contract; the source now belongs to the Silk accepted manifest and processor rather than candidate custody.
- Commissioned rope pack: `src/client/assets/patch/the-usual-specialists/rope/` contains seven accepted `724 x 2172` PNG masters generated with OpenAI image generation under Harley's direction on 13 September 2026: `rope-loose-a`, `rope-loose-b`, `rope-loose-c`, `rope-terminal-curl`, `rope-taut-straight`, `rope-taut-bow`, and `rope-taut-offset`. `accepted-assets.json` records the stable ids, source paths, SHA-256 identities and rights owner; `generation-receipt.json` records the generation tool, date, intent and retained generation ids. The masters are selectable composition material rather than seven distinct semantic roles: a chapter may reuse the same variant across multiple authored bands when that produces the cleanest physical route.
- Rope public derivatives: the shared Usual Specialists processor emits metadata-free WebP derivatives at the source dimensions with the standard `{ quality: 82, alphaQuality: 100, effort: 6, smartSubsample: true }` encoding contract. Exact outputs are `src/client/public/media/patch/the-usual-specialists/rope-loose-a.webp` (`71,874` bytes, SHA-256 `4cafce4c9e94f6a625953463fdfcac91aea4c1c6fca12d1d8f413e10e10b5f51`), `src/client/public/media/patch/the-usual-specialists/rope-loose-b.webp` (`85,432`, `fe5a27aef4c696f55e350d7e89e49bf77b989e6bc71ef61e5c0278103a973a7d`), `src/client/public/media/patch/the-usual-specialists/rope-loose-c.webp` (`83,220`, `b1818e5e84867db2551a1e21697b9acc0903006e06e12a351d050635229041ff`), `src/client/public/media/patch/the-usual-specialists/rope-terminal-curl.webp` (`91,744`, `c12e0e9bbedcd6dcce3b5472ffdf563bbfd7b56fcf4f73cade2149fccbc6b175`), `src/client/public/media/patch/the-usual-specialists/rope-taut-straight.webp` (`70,056`, `c90aab2de9ca3698ea7f75da94921fc263dc9bacc9c988dddcd9eed48ed376e1`), `src/client/public/media/patch/the-usual-specialists/rope-taut-bow.webp` (`78,014`, `186618f906d1262d71177943a4f6eb787b08f0e5dfc312c4c3e290ed7f79162f`), and `src/client/public/media/patch/the-usual-specialists/rope-taut-offset.webp` (`71,482`, `ad7ecf6f6c6c852543ac356ea46e29d8bbc95ce7ce7cddeacd6189a9b8f01979`). They are decorative route material with no independent alt-text burden; the surrounding semantic chapter content carries the narrative meaning.
- Silk reused reaction source: the moonshot wireframe continues to reuse `src/client/public/media/homepage/specialists-silk.webp` (`1983 × 793`, SHA-256 `4f72dcd76fb72c98e33fd12741e61e16b207afdc6026fdd9fdcc0431750cfd1`) behind a narrow authored plaster slit. Its existing Phase 8 custody above remains authoritative; PORT-18 creates no duplicate master or new generation claim for that image.
- Added: 2026-09-10.
