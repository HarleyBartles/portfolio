...
- Composition sources: the approved `build/characters/bit-bot/bot-role-kit/compiled_asset_sheets/sheet__v1.png` (SHA-256 `b6c676adeee34f37fe98f5a06c460f2cf2fe9459606723b7fa466d306b3b2b09`) and the cowboy, detective, mechanic and chef Patch role-kit hero sources (SHA-256 respectively `5f1f8970d5745f683e65bb4960055ecd29b19a59211ce8478d03a1ef1e1d8120`, `15511c89b88946519c4be73a33a03c2206a62842877725254b58f1e6ffd6120c`, `1a83c11a8e7302ebef6cdae136d52304ed6da898eb285674a2ea12201ca65843` and `5ec51f9d9b84b354fa8a1690b793eb312fac1e27df254f90f7c783a0ba107904`). The browser combines these assets through semantic HTML; no new narrative frame is fabricated.
- Composition derivatives: `src/client/public/media/patch/patch-identity-bot-role-kit-1200.avif` (`1200 × 788`, 51,663 bytes), `src/client/public/media/patch/patch-identity-bot-role-kit-1200.webp` (`1200 × 788`, 71,082 bytes), `src/client/public/media/patch/patch-identity-cowboy-480.avif` (`480 × 480`, 9,015 bytes), `src/client/public/media/patch/patch-identity-cowboy-480.webp` (`480 × 480`, 15,152 bytes), `src/client/public/media/patch/patch-identity-detective-480.avif` (`480 × 640`, 13,922 bytes), `src/client/public/media/patch/patch-identity-detective-480.webp` (`480 × 640`, 22,602 bytes), `src/client/public/media/patch/patch-identity-mechanic-480.avif` (`480 × 600`, 11,232 bytes), `src/client/public/media/patch/patch-identity-mechanic-480.webp` (`480 × 600`, 18,106 bytes), `src/client/public/media/patch/patch-identity-chef-480.avif` (`480 × 600`, 11,335 bytes), and `src/client/public/media/patch/patch-identity-chef-480.webp` (`480 × 600`, 19,008 bytes).
- Composition intent: distinguish right kit/wrong domain, right domain/wrong kit and Patch's successful pairing, then show that the same model extends across all four developed roles.
