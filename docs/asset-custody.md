...
- Disciplined control: `src/client/public/brand/adventures-of-patch/adventures-of-patch-control.svg` (`viewBox="0 0 340 121.7617"`, 13,637 bytes, SHA-256 `02ea705a102ec2c21498b6b7b1ca25e9a1b11a43bfc7099ab5eda3543b286e1c`). `Adventures` starts at the one-percent optical inset and resolves on the right edge of T; `of` terminates on the sharp right edge of C; H remains free; the strapline sits five units above PATCH.
- Cliff drop: `src/client/public/brand/adventures-of-patch/adventures-of-patch-cliff-drop.svg` (`viewBox="0 0 340 126.2021"`, 14,245 bytes, SHA-256 `b8ec538de8b65023ab3f37559429718aaa534d98d94295f1f94f014079daec47`). The T edge is the cliff. The final `s` moves vertically only: its top resolves to the upper edge of the preceding `e` crossbar and its bottom resolves to the PATCH cap datum. `of` still terminates on C and H remains free.
