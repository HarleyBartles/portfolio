...
ROOT = _repo_root()
EXCLUDED_DIR_NAMES = {".git", ".worktrees", ".githooks", "__pycache__", ".pytest_cache", ".superpowers"}
EXCLUDED_ROOT_NAMES = {".git", ".worktrees", ".githooks", "__pycache__", ".superpowers"}
...
NON_CANONICAL_GUARD_ROOTS = {
    ROOT / ".agents" / "docs" / "superpowers",
    ROOT / "src" / "client" / "public",
    ROOT / "src" / "client" / "src" / "data" / "content",
}
