...
class Phase6CloseoutTests(unittest.TestCase):
    def test_phase_6_roadmap_row_records_merged_closeout(self) -> None:
        ...
        self.assertEqual("done", cells[2])
        self.assertEqual(
            "[#29](https://github.com/HarleyBartles/portfolio/pull/29) · "
            "[#30](https://github.com/HarleyBartles/portfolio/pull/30)",
            cells[6],
        )
