...
This directory is the temporary canonical human-readable provenance store for accepted generated imagery used by **The Usual Specialists** while the work is owned by the Portfolio repository. The intended long-term home is the Adventures of Patch repository; that promotion is a separate future custody action.
...
- these Markdown records answer **why the asset was commissioned, what changed, what brief governed the accepted result, and why it was accepted**;
