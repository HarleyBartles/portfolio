...
const crew = [
  {
    ...
    portraitAlt: 'Index, a bookish agent carrying a blue index volume and catalogue cards.',
  ...
  },
  {
    ...
    portraitAlt: 'Writ, an institutional agent carrying official forms and a seal.',
  ...
  },
  {
    ...
    portraitAlt: 'Klause, a compact decision specialist holding a short stack of plans.',
