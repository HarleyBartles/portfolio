...
describe('IndexDeskDocument', () => {
  test('owns the desk document, story card, traversal composition, and root style override', () => {
    ...
    expect(root).toHaveTextContent('Index is already moving before Patch finishes the pitch.')
