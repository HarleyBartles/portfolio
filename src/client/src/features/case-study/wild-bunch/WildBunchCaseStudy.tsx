...
const WildBunchStorySection = styled(CaseStudySection)<{ $wide?: boolean }>`
  ...
  ${({ $wide }) => $wide ? `
    @media (min-width: 60rem) {
      ...
      > .wild-bunch-dossier { grid-column: 2; align-self: start; }
    }
  ` : ''}
    ...
    <CaseStudyBody>
      ...
      >
        <div className="wild-bunch-story-movement wild-bunch-story-movement--origin" data-story-movement="origin">
          <WildBunchStorySection title="The game I wanted to return to" layout="lead">
        ...
        <div className="wild-bunch-story-movement wild-bunch-story-movement--determinism" data-story-movement="determinism" data-project-field="constructed-world">
          <WildBunchStorySection $wide title="Making chance reproducible">
        ...
        <div className="wild-bunch-story-movement wild-bunch-story-movement--event-history" data-story-movement="event-history">
          <WildBunchStorySection $wide title="A playthrough worth keeping">
            <div className="wild-bunch-story-movement__lead">
        ...
        <div className="wild-bunch-story-movement wild-bunch-story-movement--knowledge-boundary" data-story-movement="knowledge-boundary">
          <WildBunchStorySection $wide title="The player and the developer shouldn't see the same game">
            <div className="wild-bunch-story-movement__lead">
        ...
        <div className="wild-bunch-story-movement wild-bunch-story-movement--trade-off" data-story-movement="trade-off">
          <WildBunchStorySection title="Choosing the complicated version" layout="lead">
          ...
          <WildBunchStorySection title="Where the trail leads next" layout="lead">
        ...
        <div className="wild-bunch-source-note" data-story-close="source-note">
          <WildBunchStorySection title="Inspect it. Run it." layout="lead">
