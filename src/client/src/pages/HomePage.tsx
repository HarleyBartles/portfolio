    ...
    <SiteLayout>
      ...
      <section className="working-principles" aria-labelledby="principles-title">
        ...
        <ol>
          ...
          <li><span>03</span><h3>Evidence before claims</h3><p>Source truth, validation, and review remain human responsibilities.</p><Link to="/writing/i-made-agentic-engineering-harder-than-it-needed-to-be">Read the field note</Link></li>
        </ol>
      </section>
