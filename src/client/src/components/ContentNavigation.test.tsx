...
describe('ContentNavigation', () => {
  test('links to the previous and next entries around the current story', () => {
    render(<MemoryRouter><ContentNavigation items={articles} currentSlug="second" /></MemoryRouter>)
  ...
  test('does not wrap at archive boundaries', () => {
    render(<MemoryRouter><ContentNavigation items={articles} currentSlug="first" /></MemoryRouter>)
