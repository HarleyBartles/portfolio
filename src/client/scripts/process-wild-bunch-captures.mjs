...
const CAPTURES = [
  {
    ...
    widths: [720, 1200],
    altIntent: "Current development build: Ranger Vale in Dustwell, one generated town in the seeded map-world, with its map and ordinary Store, Sheriff Office, Saloon, and trail actions visible.",
    caption: "Current development build / working skeleton: Dustwell is the generated town captured for this seed, not a hand-built showcase town.",
  },
  {
    capture: "trail-map",
    ...
    widths: [720, 1200],
    altIntent: "Current development build: the generated trail map with five named towns, connecting trails, and ride-day distances.",
    caption: "Current development build / working skeleton: the generated topology and travel distances are visible before the player chooses a town.",
  },
  {
